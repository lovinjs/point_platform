...
public record AdminStaffUpdateRequest(
    ...
    public AdminStaffUpdateCommand toCommand(Long userId, Long operatorId, String clientIp) {
        return new AdminStaffUpdateCommand(
                userId,
                realName,
                phone,
                roleCode,
